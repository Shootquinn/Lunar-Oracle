...
Authors: Shewhart, W. A. · Year: 1931 · Publisher URL: none in source · Derived at sub-step 2.6 from this file's own `## Citation` block; a field absent here is absent from that block, not inferred.
...
- **Source:** `lsei/literature/growth-and-industrial-theory/shewhart-1931-economic-control-quality.md`
- **Upstream ref:** `lsei@7f97983` — local `HEAD` = `origin/main` = the ref `oracle/VERIFIED.tsv` verifies against, all three agreeing when this was stamped, 2026-08-28; push URL DISABLED. This is the ref the bytes below were merged at.
- **Merge-time digest:** `sha256:21b1889c03a0b928c267fea8ced087a65d1dfe31e2f741b2732f12e8022973d7` over the bytes of the `Source:` file, taken 2026-08-28. This is the value `bootstrap_contract.md` §7.2 compares upstream against to reach `equal` or `diverged`; without it that verdict is `unknown`.
...
- **Dedup key:** L3|shewhart|1931|economic-control-quality-manufactured-product — no identifier is recorded for this file; the field is open, not omitted
- **Field:** economics · **Folder:** organization-and-production-systems
- **Plan row rev:** 1
- **Provenance depth:** `primary` · sub-step 2.8 (ECON-2), from `cr_scratch/step2_manager_depth.tsv`. Basis, verbatim: Citation: the 1931 monograph, the original statement of statistical process control.
