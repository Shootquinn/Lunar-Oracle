...
| The Manager (economics prompt) | `GE-1` .. `GE-12` | `ECON-` |
...
| 1.8 | LOOP-2 | Ratify the contested-claims register schema **and its single encoding**. Columns/fields, `match_keys` as the load-bearing join, the three register classes, and one worked example axis. **Integration consolidation:** three Wave 1 drafts proposed three encodings for one register (a sidecar TSV, a YAML under `literature/_registers/`, and per-file front matter). This step picks one sidecar format plus one in-file block format and nothing else; the domain personas own contents, The Engineer owns survival as corpus structure, The Software Engineer owns the assertion that consumes it. | The Software Engineer, with The Manager (economics prompt), The Space Resources Engineer, The Engineer | 1.3 (LOOP-1), 1.7 (MERGE-1) |
...
| 2.8 | ECON-2 | Add a `provenance_depth` field to every economics summary: `primary`, `via_review`, `via_tertiary`. At minimum `may-1977`, `simonis-1979` and `henderson-2008` are not primary, and between them they are the corpus's only route to the Denison and Chung decomposition. | The Engineer (write), The Manager (economics prompt) (assign values for the corpus-unique files) | 2.6 (MERGE-6) |
| 2.9 | ECON-3 | Rule on whether the Denison and Chung 1976 monograph is acquired. Either acquire and summarise it, or mark the register row permanently `neither` and hard-block any answer stating a Denison figure without the review label. | The Manager (economics prompt) (recommends), the author (rules at a gate) | 2.8 (ECON-2) |
...
| 1.8 (LOOP-2) | The Software Engineer, The Manager (economics prompt), The Space Resources Engineer, The Engineer | `step0_software_engineer_loop.md` §3.6. `step0_space_resources_engineer_question_surface.md` §5.1–5.3. `step0_growth_economist_question_surface.md` Part 4. The Engineer's merge taxonomy. **Do not load the corpus.** |
...
| 1.10 (ECON-1) | The Manager (economics prompt) | `step0_growth_economist_question_surface.md` Part 4 (full). 1.8 (LOOP-2)'s ratified schema. The `lsei/literature/` and `_intake/japanese-miracle/lit/` tree listings. Any summary flagged ambiguous, in full. |
...
| 2.3 (MERGE-4) | The Space Resources Engineer / The Manager (economics prompt) (review) | The proposed folder table and the assignment list for their own folders. No file bodies. |
...
| 2.8 (ECON-2) | The Manager (economics prompt) | `may-1977-…-review`, `simonis-1979-denison-boltho-review`, `henderson-2008-myth-of-miti` in full. Citation blocks only for the other corpus-unique files. |
| 2.9 (ECON-3) | The Manager (economics prompt) | The two review summaries in full. The mechanism-table source ledger entry if 1.2 (ECON-12) ruled the FA deliverables in. |
...
| 4.2 (ECON-6) | The Software Engineer, The Manager (economics prompt) | `step0_growth_economist_question_surface.md` parts 3, 4 and 5. The landed register with its class column. `cr-agents/method/tdd_method.md` (full). **Not** the corpus; the invariants are structural. |
| 4.3 (ECON-10) | The Software Engineer, The Manager (economics prompt) | `pritchett-2000`, `hausmann-2005`, `flyvbjerg-2014` summaries in full. 4.2 (ECON-6)'s invariant. |
...
| 4.4 (ECON-4) | The Manager (economics prompt) | Parts 2 and 3 of his own file. The worked example in §5.2 as the acceptance target. |
| 4.5 (ECON-5) | The Software Engineer, The Manager (economics prompt) | `kiyota-2005`, `lewis-1954`, `beckley-2018` summaries in full. `cr-agents/method/tdd_method.md`. `operational_guide.md` A.10. |
...
| 7.1 (ECON-8) | The Manager (economics prompt) | All corpus-unique economics summaries. `lewis-1954`, `hausmann-2005`, `caballero-2008`, `flyvbjerg-2014`, `henderson-2008`. `FA1-mechanism-table.md` if 1.2 (ECON-12) ruled it in. |
...
| 7.3 (ECON-11) | The Manager (economics prompt) | `jorgenson-2005` (the asset table and depreciation methodology), `beckley-2018`, `dingman-1993`. The app's `grade-independent-demand` exclusion prose. |
...
The Manager (economics prompt)'s ruling is that an FA deliverable is not the same kind of object as a summary.
...
| **15 / 17** | Lunar register rows and economics register rows drafted at 0.2. One row (the shared axis) is written once and appears in both namespaces. | The Space Resources Engineer §5.4; The Manager (economics prompt) part 4 | Drafted, lands at 2.16 (MERGE-10) |
...
### 9.1 The Manager (economics prompt) against The Space Resources Engineer: which necessary condition binds first

| | **The Space Resources Engineer** | **The Manager (economics prompt)** |
|---|---|---|
...
coefficient's status field to be part of what the app computes; The Manager (economics prompt) wants the app's
authority *smaller and sharper* and the ten exclusions promoted to first-class answers. The Systems
Engineer expected to disagree with The Manager (economics prompt) about the corpus becoming co-authoritative;
The Manager (economics prompt)'s stated position is that he opposes exactly that. **They agree, and each wrote
